<template>
	<el-container style="height: 100vh; border: 1px solid #eee">
	  ...
	  height: 100%;box-shadow: 2px 0 6px rgb(0 21 41 / 35%);">
	    ...
	    active-text-color="#ffd04b"
		 ...
		 <div style="height: 60px;line-height: 60px;text-align: center;">
		 	<!-- <img src= require(../assets/logo.png) alt="" width="20px" style="position: relative;top: 5px;margin-right: 5px;"> -->
		 	<img src="../assets/logo.png" alt="" width="20px" style="position: relative; top: 5px;margin-right: 5px;">
		 ...
		 <el-submenu index="1">
		  ...
		  <el-submenu index="3">
		    <template slot="title">
		  	...
		  	<el-menu-item index="/main/Login">地址管理</el-menu-item>
		  </el-submenu>
		  <!-- 供应商管理 -->
		  <el-submenu index="4">
		    <template slot="title">
		  	...
		  	<el-menu-item index="/main/Login">供应商管理</el-menu-item>
		  </el-submenu>
		  ...
		  <el-submenu index="6">
		    <template slot="title">
		  				<i class="el-icon-odometer"></i>
		  				<span slot="title">图标分析</span>
		  			</template>
		  	<el-menu-item index="/main/charts">图标分析</el-menu-item>
		  </el-submenu>
	  ...
	  <el-container>
		<!-- 头部内容 -->
	    <el-header
				 style="font-size: 14px;border-bottom: 1px solid #ccc;line-height: 60px;display: flex;">
	      	<!-- div收缩按钮 -->
	      	...
	      	<el-dropdown style="width: 150px;cursor: pointer;">
	      		...
	      		<el-dropdown-menu slot="dropdown">
                    <span style="float: right;">欢迎{{this.userObj.name}}登录</span>
