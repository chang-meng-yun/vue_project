	...
	export default {
		...
		methods: {
			...
			submitForm(formName){
				...
				console.log((this.BillObj.createdDate).format('yyyy-MM-dd HH:mm:ss'))



				// var aa =  new Date(this.BillObj.createdDate).toLocaleDateString()+' '+new Date(this.BillObj.createdDate).toLocaleTimeString()
				//String转Date
