	...
	<div>
		<div>
			...
			<el-form :inline="true" :model="queryCondition" class="demo-form-inline">
				...
				<el-form-item>
					<el-input v-model="queryCondition.id" placeholder="供货商ID" style="width: 140px;"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<div>
			<!-- 数据显示区域 -->
			<el-table :data="providerData" style="width: 100%" stripe border ref="multipleTable" tooltip-effect="dark"
...
<script>
	export default {
		...
		methods: {
			    // 导出
				exportExcel(){
               window.location.href="http://localhost:8080/ssm_market_project/provider/exportExcel";
               console.log("aaa")
            },
			// 分页相关功能
			...
			deleteAll() {
				...
				this.$confirm('确认删除多条供货商吗?', '提示', {
					...
					console.log(idList);
					this.$deleteRequest('/provider/deletePros?ids='+idList).then(res => {
                        this.query()
					})
					this.$message({
						type: 'success',
