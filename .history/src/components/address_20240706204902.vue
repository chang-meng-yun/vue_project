        ...
        <el-dialog title="添加地址" :visible.sync="saveMark">
            <el-form :model="addressObj">
                ...
                <el-form-item label="创建者" :label-width="formLabelWidth">
                    <el-input v-model="addressObj.createdBy" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="创建时间" :label-width="formLabelWidth">
                    <el-input v-model="addressObj.creationDate" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="修改者" :label-width="formLabelWidth">
                    <el-input v-model="addressObj.modifyBy" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="修改时间" :label-width="formLabelWidth">
                    <el-input v-model="addressObj.modifyDate" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="活动区域" :label-width="formLabelWidth">
                    <el-select v-model="addressObj.contact" placeholder="请选择活动区域">
