    ...
    <div>
        ...
        <el-dialog title="添加地址" :visible.sync="saveMark">
            <el-form :model="addressObj" status-icon class="demo-ruleForm" :rules="rules" ref="ruleForm">
                ...
                <el-date-picke v-model="addressObj.creationDate" autocomplete="off" type="hidden" type="datetime" format="yyyy-MM-dd HH:mm:ss"></el-date-picke>
                <!-- </el-form-item> -->
...
<script>
    export default {
        ...
        methods: {
            ...
            submitForm(formName){
                this.saveMark = false
                this.addressObj.createdBy = this.userObj.username;
                // 获取当前时间
                var data = new Date();
                this.addressObj.creationDate = data;
                console.log(data)
            },
        },
        data() {
