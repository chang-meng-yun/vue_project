        ...
        <el-dialog title="添加地址" :visible.sync="saveMark">
            <el-form :model="addressObj" status-icon class="demo-ruleForm" :rules="rules" ref="ruleForm">
                <el-form-item label="联系人" :label-width="formLabelWidth">
                    <el-input v-model="addressObj.contact" autocomplete="off" prop="contact"></el-input>
                </el-form-item>
                <el-form-item label="地址描述" :label-width="formLabelWidth">
                    <el-input v-model="addressObj.addressDesc" autocomplete="off" prop="addressDesc"></el-input>
                </el-form-item>
                <el-form-item label="邮编" :label-width="formLabelWidth">
                    <el-input v-model="addressObj.postCode" autocomplete="off" prop="postCode"></el-input>
                </el-form-item>
                <el-form-item label="联系电话" :label-width="formLabelWidth">
                    <el-input v-model="addressObj.tel" autocomplete="off" prop="tel"></el-input>
                </el-form-item>
                ...
                <el-input v-model="addressObj.creationDate" autocomplete="off" type="hidden"></el-input>
                <!-- </el-form-item> -->
