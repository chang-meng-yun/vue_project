<template>
	<div>
		...
		<el-dialog title="新增订单" :visible.sync="saveMark">
			<el-form :model="BillObj">
				<el-form-item label="订单编号" :label-width="formLabelWidth">
					<el-input v-model="BillObj.proCode" autocomplete="off"></el-input>
				</el-form-item>
				...
				<!-- 创建者 默认为登录用户 -->
				<!-- <el-form-item> -->
					<el-input v-model="BillObj.createdBy" autocomplete="off" type="hidden"></el-input>
				<!-- </el-form-item> -->
				<el-form-item label="订单日期" :label-width="formLabelWidth"  type="date" >
					<el-input v-model="BillObj.createdDate" autocomplete="off"></el-input>
				</el-form-item>
              
				<el-form-item label="活动区域" :label-width="formLabelWidth">
					<el-select v-model="BillObj.productName" placeholder="请选择活动区域">
