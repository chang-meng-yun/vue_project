	...
	export default {
		...
		methods: {
			...
			submitForm(formName){
				...
				// console.log()
				var year = this.BillObj.creationDate.getUTCFullYear();
				var month = this.BillObj.creationDate.getUTCMonth();
				var day = this.BillObj.creationDate.getUTCDate();
				var hours = this.BillObj.creationDate.getHours();
				var minutes = this.BillObj.creationDate.getMinutes();
				var seconds = this.BillObj.creationDate.getSeconds();
				

				var hh = year+"-"+month+"-"+day+" "+hours+":"+minutes+":"+seconds;
				console.log(hh)
				this.BillObj.creationDate=hh;
