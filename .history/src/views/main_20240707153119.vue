        ...
        <el-container>
            ...
            <el-header style="font-size: 14px;border-bottom: 1px solid #ccc;line-height: 60px;display: flex;">
                ...
                <el-upload class="avatar-uploader" action="https://jsonplaceholder.typicode.com/posts/"
                            ...
                            <img v-if="userObj.user_face" :src="userObj.user_face" class="avatar" style="width: 30px;height: 30px; border-radius: 50%;position: relative;top:5px;margin-right: 5px;">
