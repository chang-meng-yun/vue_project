			...
			<el-form :inline="true" :model="queryCondition" class="demo-form-inline">
				...
				<el-form-item>
					<el-select v-model="queryCondition.providerId" placeholder="供应商">
						<el-option :label="obj.proName" :value="obj.id" v-for="(obj,index) in provides"></el-option>
					</el-select>
				</el-form-item>
				<el-form-item>
...
<script>
	export default {
		...
		methods: {
			...
			// 查询按钮的功能
			query() {
                this.$postRequest('',this.queryCondition).then(res=>{
                if(res){
                    this.providesList = res.data.providers;
