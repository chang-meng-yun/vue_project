    ...
    <div style="width: 1100px;margin: 0 auto;">
        ...
        <el-dialog title="收货地址" :visible.sync="adduser">
            <el-form :model="form">
                ...
                <el-table-column prop="date" label="日期" width="180">11</el-table-column>
                <el-table-column prop="name" label="姓名" width="180">11</el-table-column>
                <el-table-column prop="address" label="地址">11</el-table-column>
            </el-form>
