	  ...
	  height: 100%;box-shadow: 2px 0 6px rgb(0 21 41 / 35%);">
            <el-menu style="height: 100%;overflow-x: hidden;" background-color="rgb(48,68,88)" text-color="#fff"
                ...
                <el-submenu index="1">
                    ...
                    <el-menu-item index="/main/inform" v-if="userObj.userrole>1">用户管理</el-menu-item>
                </el-submenu>
                <el-submenu index="2">
                    <template slot="title">
                ...
                <!-- 日志管理 -->
                <el-submenu index="5" v-if="userObj.userrole==1">
                    <template slot="title">
                        <i class="el-icon-user"></i>
                        <span slot="title">日志管理</span>
                    </template>
                    <el-menu-item index="/main/log">日志管理</el-menu-item>
                </el-submenu>

                <!-- 图表管理 -->
                <el-submenu index="6"  v-if="userObj.userrole==1">
                    <template slot="title">
                        <i class="el-icon-pie-chart"></i>
                        <span slot="title">图表管理</span>
                    </template>
                    <el-menu-item index="/main/chart">每月分析</el-menu-item>
                </el-submenu>
    ...
    export default {
        ...
        methods: {
            ...
            handleAvatarSuccess(res, file) {
                ...
                this.$postRequest('/login/updateImg',this.userObj).then(res => {
                    console.log(this.userObj)
                    })
            },
