...
<script>
    export default {
        ...
        methods: {
            ...
            submitForm(formName){
                this.saveMark = false
                this.addressObj.createdBy = this.userObj.name;
                // 获取当前时间
                var data = new Date(this.addressObj.creationDate).toLocaleDateString()+" "+ new Date(this.addressObj.creationDate).toLocaleTimeString;
